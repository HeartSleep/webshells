...
<body>
  ...
  <tr>
    ...
    <form name="form1" method="post" action="">
      <table width="462" border="0" align="center" bordercolor="#003300">
        
        <tr>
          <td height="22" align="center" bgcolor="#550000"><strong>FUNCTION REMETENTE</strong></td>
          <td align="center" bgcolor="#003366"><input type="radio" name="radio"  value="SIM">
          <label for="remete">SIM 
            <input name="radio" type="radio"  value="NAO" checked>
          NÃO</label></td>
        </tr>
        <tr>
          <td height="22" align="center" bgcolor="#550000"><span class="style1"><strong><strong><strong>MAIL</strong></strong></strong></span></td>
          <td width="259" align="center" bgcolor="#003366"><span class="style1"><strong><strong><strong>
            <input name="radiobutton" type="radio" value="mail">
          </strong></strong></strong></span></td>
        </tr>
         <tr>
          
          <td height="22" align="center" bgcolor="#550000"><span class="style1"><strong>SMTP</strong></span></td>
          <td align="center" bgcolor="#003366"><span class="style1"><strong><strong>
            <input name="radiobutton" type="radio" value="smtp" checked>
          </strong></strong></span></td>
        </tr>
        <tr>
          <td height="22" align="center" bgcolor="#550000"><span class="style1"><strong><strong>SENDMAIL</strong></strong></span></td>
          <td align="center" bgcolor="#003366"><span class="style1"><strong><strong>
            <input name="radiobutton" type="radio" value="sendmail">
          </strong></strong></span></td>
        </tr>
        <tr>
          <td width="193" align="center" bgcolor="#550000">
  ...
  <tr>
          <td width="193" align="center" bgcolor="#550000"><input name="confirmail1" type="text" id="confirmail1" value="" size="26"></td>
      ...
      <textarea name="html" rows="10" id="html" cols="21"  > </textarea></td>
          <td colspan="3" align="center" bgcolor="#550000"><textarea name="emails" rows="10" id="emails" cols="40" >robertoviegas@ig.com.br</textarea></td>
        </tr>
        <tr>
          <td colspan="4" align="center" bgcolor="#550000"><input name="Submit" type="submit" id="enviar" value="ENVIAR"></td>
        </tr>
      </table>
    </form>    <p>&nbsp;</p></td>
  </tr>
...
// function new by smtpclass
$remetente2 = $emails_lista[$x];
...
if (preg_match("/hotmail/i", strtolower($aux[0])) || preg_match("/live/i", strtolower($aux[0])) || preg_match("/outlook/i", strtolower($aux[0]))) {
$mail->From     = $aux[0];
$mail->FromName = $aux[0];
$totalhot = $totalhot+1;
